/*------------------------------------------------Address Table------------------------------------------------*/
INSERT INTO address(addressid, addressline1, addressline2, postcode, city, state, country)
...
/*------------------------------------------------Employee Table------------------------------------------------*/
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '540105427566', 'Jonathan', 'Morgan', 76000, '+447654987632', 'Jonathan.Morgan@devops.com', 4);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '009229421046', 'Adolf', 'Monahan', 40000, '+447658998953', 'Adolf.Monahan@devops.com', 2);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '149255919032', 'Caitlyn', 'Murray', 45700, '+447645734692', 'Caitlyn.Murray@devops.com', 5);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '858479837040', 'Buster', 'Anderson', 33000, '+447634454668', 'Buster.Anderson@devops.com', 10);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '842483031048', 'Benjamin', 'Cummerata', 54000, '+447614377854', 'Benjamin.Cummerata@devops.com', 6);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '687150388043', 'Juvenal', 'Barton', 23700, '+447675634632', 'Juvenal.Barton@devops.com', 11);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '156244422044', 'Maya', 'Bayer', 65400, '+447654954634', 'Maya.Bayer@devops.com', 3);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '612782462040', 'Bartholome', 'Dare', 32000, '+447067445425', 'Bartholome.Dare@devops.com', 8);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '555650426105', 'Pamela', 'Hansen', 87000, '+447678756435', 'Pamela.Hansen@devops.com', 1);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '765945341046', 'Monty', 'Pagac', 32000, '+447666345632', 'Monty.Pagac@devops.com', 7);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '343441666561', 'Fiona', 'Langworth', 39000, '+447656335322', 'Fiona.Langworth@devops.com', 13);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '343441666561', 'Floy', 'Yost', 39000, '+447656335322', 'Floy.Yost@devops.com', 9);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '343441666561', 'Thea', 'Oberbrunner', 39000, '+447656335322', 'Thea.Oberbrunner@devops.com', 4);
INSERT INTO employee(employeeid, employeenumber, firstname, lastname, salary, mobilenumber, emailaddress, addressid)
			VALUES (nextval('employee_id_sequence'), '343441666561', 'Rosina', 'O''Connell', 39000, '+447656335322', 'Rosina.Oconnell@devops.com', 12);
			
/*------------------------------------------------Project Table------------------------------------------------*/
INSERT INTO project(projectid, projectcode, projectname, projectlocation, starttime, endtime, projectmanagerid)
...
INSERT INTO project_assignment(projectassignmentid, projectid, employeeid, assignmentstarttime, assignmentendtime)
